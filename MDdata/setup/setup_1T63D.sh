#!/bin/bash
# Setup protein-only (apo) 1T63D for 2D WT-MetaD.
...
#src_gro="data/${sys}/1T63D_DNA_${ff}_${wat}_ions${ions}.gro"
#src_tpr="data/${sys}/1T63D_DNA_${ff}_${wat}_ions${ions}_md.tpr"
