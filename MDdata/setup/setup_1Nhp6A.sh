#!/bin/bash
# Setup protein-only (apo) 1Nhp6A for 2D WT-MetaD.
...
src_gro="data/${sys}/1Nhp6A_DNA_${ff}_${wat}_ions${ions}.gro"
src_tpr="data/${sys}/1Nhp6A_DNA_${ff}_${wat}_ions${ions}_md.tpr"
